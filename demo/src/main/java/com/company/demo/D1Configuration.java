...
@PropertySource(name = "com.company.demo", value = "classpath:/com/company/demo/module.properties")
public class D1Configuration {

    @Bean("d1_D1ViewControllers")
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("com.company.demo"));
    ...
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("com.company.demo"));
        return actions;
    }
}
